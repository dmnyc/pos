...
export function Share() {
  ...
  return (
    <>
      <Template title="Share">
        <div className="flex flex-col gap-4 md:gap-6 lg:gap-8 items-center">
          <p className="text-sm md:text-base lg:text-lg text-center">Scan to connect another device:</p>
          ...
          <p className="text-sm md:text-base lg:text-lg text-center">or copy the link below:</p>
