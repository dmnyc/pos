export interface MerchantConfig {
  ...
  logoUrl: string;
  description: string;
  theme: "standard" | "industrial" | "orangepill" | "nostrich" | "beehive" | "liquidity" | "acidity" | "nutjob" | "safari" | "solidstate" | "blocktron" | "surfboard";
...
export function applyMerchantConfigFromUrl(searchParams: URLSearchParams): void {
  ...
  if (theme && ["standard", "industrial", "orangepill", "nostrich", "beehive", "liquidity", "acidity", "nutjob", "safari", "solidstate", "blocktron", "surfboard"].includes(theme)) {
...
function applyCompressedConfig(configObject: CompressedConfig): void {
  ...
  if (configObject.theme && ["standard", "industrial", "orangepill", "nostrich", "beehive", "liquidity", "acidity", "nutjob", "safari", "solidstate", "blocktron", "surfboard"].includes(configObject.theme)) {
