      ...
      <div className="w-10 md:w-12 lg:w-16 wide:w-16 flex justify-center items-center">
        {location.pathname !== "/wallet/tiponly" ? (
          ...
          <div className="relative flex items-center justify-center">
            <span className="absolute right-full whitespace-nowrap mr-1.5 text-[10px] md:text-xs lg:text-xs wide:text-sm text-red-600 self-center font-bold">Tip Only</span>
            <Link 
              to="../new" 
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5 md:h-5 md:w-5 lg:h-6 lg:w-6 wide:h-6 wide:w-6">
