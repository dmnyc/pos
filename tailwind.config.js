  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'acidity-gradient': 'linear-gradient(-10deg, #24BDC2, #0ABFDB, #69C184, #A4CF5A, #A7D056, #B3D44D, #C5DA3D, #D6E030)',
        'acidity-hover': 'linear-gradient(-10deg, #14ADB2, #00AFCB, #59B174, #94BF4A, #97C046, #A3C43D, #B5CA2D, #C6D020)',
