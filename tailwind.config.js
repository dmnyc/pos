  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'acidity-gradient': 'linear-gradient(-10deg, #D6E030, #C5DA3D, #B3D44D, #A7D056, #A4CF5A, #69C184, #0ABFDB, #24BDC2)',
        'acidity-hover': 'linear-gradient(-10deg, #C6D020, #B5CA2D, #A3C43D, #97C046, #94BF4A, #59B174, #00AFCB, #14ADB2)',
    ...
    themes: [
      ...
      },
      {
        acidity: {
          ...
          secondary: "#FFFFFF", // White for secondary elements
          "secondary-content": "#000000", // Black text on secondary elements
          accent: "#0ABFDB", // Bright teal for accent elements
